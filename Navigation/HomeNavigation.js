    ...
    return (
        <Router>
            ...
            <Scene key='root' navigationBarStyle={{ backgroundColor: '#00CC6A' }} headerTintColor="white">
                ...
                <Scene key='case2' component={Case2} drawer={true} title='Choix de partie' renderRightButton={(props) => <DropDownMenu {...props} help={'Ici vous avez le choix sur la partie que vous voulez commencer avec, l\'orsque vous terminer cette partie vous choisisez une autre partie j\'usquà avoir satisfait tous les parties, enfin votre constat va être enregistré dans la page constat.'} component={'case2'} />}></Scene>
                {/*Amicable report case2 driver A*/}
                <Scene key='case2Choice1Step1' component={Case2Choice1Step1} title='Étape 1' renderRightButton={(props) => <DropDownMenu {...props} help={'Dans cette étape vous êtes cencé remplir toutes les informations à propos du premier véhicule, cliquez sur le champs pour le remplir, et si vous terminez cliquez suivant pour enregistrer les données.'} component={'part'} />}></Scene>
                <Scene key='case2Choice1Step2' component={Case2Choice1Step2} title='Étape 2' renderRightButton={(props) => <DropDownMenu {...props} help={'Dans cette étape vous êtes cencé remplir toutes les informations à propos du premier assuré , cliquez sur le champs pour le remplir, et si vous terminez cliquez suivant pour enregistrer les données.'} component={'part'} />}></Scene>
                <Scene key='case2Choice1Step3' component={Case2Choice1Step3} title='Étape 3' renderRightButton={(props) => <DropDownMenu {...props} help={'Dans cette étape vous êtes sencé remplir toutes les informations à propos du premier conducteur , cliquez sur le champs pour le remplir, et si vous terminez cliquez suivant pour enregistrer les données.'} component={'part'} />}></Scene>
                <Scene key='case2Choice1Step4' component={Case2Choice1Step4} title='Étape 4' renderRightButton={(props) => <DropDownMenu {...props} help={'Dans cette étape vous êtes cencé prendre une image du premier véhicule, et si vous terminez cliquez suivant pour enregistrer l\'image'} component={'part'} />}></Scene>
                ...
                <Scene key='case2Choice2Step1' component={Case2Choice2Step1} title='Étape 1' renderRightButton={(props) => <DropDownMenu {...props} help={'Dans cette étape vous êtes cencé remplir toutes les informations à propos du deuxième véhicule, cliquez sur le champs pour le remplir, et si vous terminez cliquez suivant pour enregistrer les données.'} component={'part'} />}></Scene>
                <Scene key='case2Choice2Step2' component={Case2Choice2Step2} title='Étape 2' renderRightButton={(props) => <DropDownMenu {...props} help={'Dans cette étape vous êtes cencé remplir toutes les informations à propos du deuxième assuré , cliquez sur le champs pour le remplir, et si vous terminez cliquez suivant pour enregistrer les données.'} component={'part'} />}></Scene>
                <Scene key='case2Choice2Step3' component={Case2Choice2Step3} title='Étape 3' renderRightButton={(props) => <DropDownMenu {...props} help={'Dans cette étape vous êtes cencé remplir toutes les informations à propos du deuxième conducteur , cliquez sur le champs pour le remplir, et si vous terminez cliquez suivant pour enregistrer les données.'} component={'part'} />}></Scene>
                <Scene key='case2Choice2Step4' component={Case2Choice2Step4} title='Étape 4' renderRightButton={(props) => <DropDownMenu {...props} help={'Dans cette étape vous êtes cencé prendre une image du deuxième véhicule, et si vous terminez cliquez suivant pour enregistrer l\'image.'} component={'part'} />}></Scene>
                ...
                <Scene key='case2Choice3Step1' component={Case2Choice3Step1} title='Étape 1' renderRightButton={(props) => <DropDownMenu {...props} help={'Dans cette étape chaque conducteur doit cocher la case utile à propos de l\'accident, cliquez suivant si vous terminer l\'étape.'} component={'part'} />}></Scene>
                <Scene key='case2Choice3Step2' component={Case2Choice3Step2} title='Étape 2' renderRightButton={(props) => <DropDownMenu {...props} help={'Dans cette étape chaque conducteur doit cocher la case utile à propos de l\'accident, cliquez suivant si vous terminer l\'étape.'} component={'part'} />}></Scene>
                <Scene key='case2Choice3Step3' component={Case2Choice3Step3} title='Étape 3' renderRightButton={(props) => <DropDownMenu {...props} help={'Dans cette étape chaque conducteur doit cocher la case utile à propos de l\'accident, cliquez suivant si vous terminer l\'étape.'} component={'part'} />}></Scene>
                <Scene key='case2Choice3Step4' component={Case2Choice3Step4} title='Étape 4' renderRightButton={(props) => <DropDownMenu {...props} help={'Dans cette étape chaque conducteur doit cocher la case utile à propos de l\'accident, cliquez suivant si vous terminer l\'étape.'} component={'part'} />}></Scene>
                <Scene key='case2Choice3Step5' component={Case2Choice3Step5} title='Étape 5' renderRightButton={(props) => <DropDownMenu {...props} help={'Dans cette étape chaque conducteur doit cocher la case utile à propos de l\'accident, cliquez suivant si vous terminer l\'étape.'} component={'part'} />}></Scene>
                <Scene key='case2Choice3Step6' component={Case2Choice3Step6} title='Étape 6' renderRightButton={(props) => <DropDownMenu {...props} help={'Dans cette étape chaque conducteur doit cocher la case utile à propos de l\'accident, cliquez suivant si vous terminer l\'étape.'} component={'part'} />}></Scene>
