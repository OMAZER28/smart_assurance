...
export default Follow = () => {
    ...
    openTheMenu = () => {
        ...
        setRoute2Style(styles.routeOnOpenMenu)
        setRoute2TitleStyle(styles.routeTitleOnOpenMenu)
        setRoute2Active(true)
    }
    closeTheMenu = () => {
