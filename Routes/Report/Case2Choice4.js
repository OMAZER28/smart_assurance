...
import { View, Image, Button, StyleSheet, TouchableWithoutFeedback, Text } from 'react-native'
import firebase from '../../database/firebaseDb';
import { Actions } from 'react-native-router-flux';

export default class Case2Choice4 extends Component {
    goToCase2 = () => {
        Actions.case2({ isChoice4Disabled: true })
    }
    ...
    saveCanvas = async () => {
        ...
        this.uploadImage(signature_result.uri, "croquis");
        this.goToCase2();
    }
