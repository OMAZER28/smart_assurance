...
export default class Case2Choice2Step5 extends Component {
    ...
    saveCanvas = async (uri) => {
        ...
        this.uploadImage(uploadUri, "signatureB_" + id);
        setTimeout(() => {
            this.setState({
                isLoading: false,
            });
...
AppRegistry.registerComponent('Case2Choice2Step5', () => Case2Choice2Step5);