...
export default class Case2Choice3Step2 extends React.Component {
  constructor(props) {
    super(props);
  ...
  goToCase2Choice3Step3 = () => {
    Actions.case2Choice3Step3({ isChoice1Disabled: this.props.isChoice1Disabled,
