                ...
                <View style={styles.container}>
                        ...
                        this.state.reportArr.length == 0 && (
                            <View style={styles.fileIcon}>
                                <View style={styles.iconContainer}>
                                    <FileIcon name='file-document-edit-outline' color='#00CC55' size={normalize(125, 'width')} />
                                </View>
                                <View>
                        ...
                        this.state.reportArr.length != 0 && (
                            this.state.reportArr.map((item, i) => {
                                return (
                                    <ListItem
                                        key={i}
                                        leftElement={<File name='file-text' color='#00EA65' size={normalize(45,"width")}/>}
                                        rightElement={
                                            <TouchableOpacity onPress={() => this.delReport(item.uid, item.date)}>
                                                <DeleteIcon name='trash' color='rgba(255,0,0,0.8)' size={normalize(25,"width")} />
                                            </TouchableOpacity>
                                        }
                    ...
                    <View style={styles.addIcon}>
                        <TouchableOpacity onPress={() => this.goToCommonPage()}>
                            <AddIcon name='addfile' color='white' size={normalize(30,"width")} />
                        </TouchableOpacity>
                    </View>
                </View>
            </Container>
